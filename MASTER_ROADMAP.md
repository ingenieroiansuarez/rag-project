...
**Architecture:** Operationally deterministic at the RAG pipeline level, idempotent, anti-hallucination  
...
- All operations reproducible at the pipeline level once upstream HF calls are cached (same normalized input + cached embeddings = same output)
